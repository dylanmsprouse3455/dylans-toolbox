...
export default function Toolbox(){
  ...
  async function microphone(focusId?:string,channel:'capture'|'ai'='capture'){
    ...
    const conversation={reply_to:channel==='ai'?lastTurnRef.current?.id:lastTurnRef.current?.needs_clarification?lastTurnRef.current.id:undefined,focus_id:focusId,channel};

...
const entry=(id=randomUUID())=>({id,type:'task',title:'Bring catnip to work',content:'',area:'Work',importance:3,urgency:4,due_at:null,due_date:'2026-09-12',parent_id:null});
const patch=(id:string,version:string,extra:object={})=>({item_id:id,expected_updated_at:version,status:null,change_due:false,due_at:null,due_date:null,title:null,content:null,area:null,...extra});
